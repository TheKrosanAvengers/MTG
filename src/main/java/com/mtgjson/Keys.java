...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<CardsRecord, SetsRecord> FK_CARDS_SETS_1 = Internal.createForeignKey(com.mtgjson.Keys.PK_SETS, Cards.CARDS, "fk_cards_sets_1", Cards.CARDS.SETCODE);
        public static final ForeignKey<ForeignDataRecord, CardsRecord> FK_FOREIGN_DATA_CARDS_1 = Internal.createForeignKey(com.mtgjson.Keys.PK_CARDS, ForeignData.FOREIGN_DATA, "fk_foreign_data_cards_1", ForeignData.FOREIGN_DATA.UUID);
        public static final ForeignKey<LegalitiesRecord, CardsRecord> FK_LEGALITIES_CARDS_1 = Internal.createForeignKey(com.mtgjson.Keys.PK_CARDS, Legalities.LEGALITIES, "fk_legalities_cards_1", Legalities.LEGALITIES.UUID);
        public static final ForeignKey<PricesRecord, CardsRecord> FK_PRICES_CARDS_1 = Internal.createForeignKey(com.mtgjson.Keys.PK_CARDS, Prices.PRICES, "fk_prices_cards_1", Prices.PRICES.UUID);
        public static final ForeignKey<RulingsRecord, CardsRecord> FK_RULINGS_CARDS_1 = Internal.createForeignKey(com.mtgjson.Keys.PK_CARDS, Rulings.RULINGS, "fk_rulings_cards_1", Rulings.RULINGS.UUID);
        public static final ForeignKey<SetTranslationsRecord, SetsRecord> FK_SET_TRANSLATIONS_SETS_1 = Internal.createForeignKey(com.mtgjson.Keys.PK_SETS, SetTranslations.SET_TRANSLATIONS, "fk_set_translations_sets_1", SetTranslations.SET_TRANSLATIONS.SETCODE);
        public static final ForeignKey<TokensRecord, SetsRecord> FK_TOKENS_SETS_1 = Internal.createForeignKey(com.mtgjson.Keys.PK_SETS, Tokens.TOKENS, "fk_tokens_sets_1", Tokens.TOKENS.SETCODE);
    }
}
